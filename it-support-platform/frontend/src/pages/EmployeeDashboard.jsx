...
import {
  MessageCircle, PlusCircle, LogOut,
...
export default function EmployeeDashboard() {
  ...
  useEffect(() => {
    fetchTickets();
    // Auto-refresh every 30s to catch agent status updates
      ...
      <main className="max-w-5xl mx-auto p-6 space-y-6">
        ...
        <div className="bg-slate-800 rounded-xl border border-slate-700">
          <div className="px-5 py-4 border-b border-slate-700 flex justify-between items-center">
            <h3 className="font-semibold">Active Tickets ({activeTickets.length})</h3>
        ...
        {resolved.length > 0 && (
          <div className="bg-slate-800 rounded-xl border border-slate-700">
            <div className="px-5 py-4 border-b border-slate-700 flex justify-between items-center">
              <h3 className="font-semibold text-emerald-400">Resolved Tickets ({resolved.length})</h3>
              <Link to="/tickets" className="text-blue-400 text-sm hover:text-blue-300">View all →</Link>
            </div>
            <div className="divide-y divide-slate-700/50">
